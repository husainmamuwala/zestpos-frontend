...
//         credentials: "include", // <--- important: allow browser to accept HttpOnly cookie
...
//       // Optionally store non-sensitive info for UI (NOT the JWT)
//       try {
//         localStorage.setItem("zestpos_user_email", email);
//         localStorage.setItem("zestpos_logged_in_at", Date.now().toString());
//       } catch {}

//       // Redirect to dashboard or to "next" param
